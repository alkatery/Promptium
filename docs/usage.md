...
لا توفر هذه المنصات حالياً مساعدين مخصصين دائمين بنفس المرونة، فاستخدم اللصق المباشر في بداية كل محادثة. مع السياق المحدود يُفضَّل استخدام [النسخة المختصرة](../versions/prompt-lite.ar.md).

---

## 6️⃣ مع مولّدات الصور والفيديو
